 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class bg{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(n=>{if(Eg(n)){const r=n.getImmediate();return`${r.library}/${r.version}`}else return null}).filter(n=>n).join(" ")}}function Eg(t){const e=t.getComponent();return(e==null?void 0:e.type)==="VERSION"}const ho="@firebase/app",Sl="0.9.10";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const fo="[DEFAULT]",Gg={[ho]:"fire-core",[Ig]:"fire-core-compat",[Ag]:"fire-analytics",[Tg]:"fire-analytics-compat",[Cg]:"fire-app-check",[Sg]:"fire-app-check-compat",[Rg]:"fire-auth",[Og]:"fire-auth-compat",[Pg]:"fire-rtdb",[kg]:"fire-rtdb-compat",[Dg]:"fire-fn",[xg]:"fire-fn-compat",[Ng]:"fire-iid",[Lg]:"fire-iid-compat",[$g]:"fire-fcm",[Mg]:"fire-fcm-compat",[Ug]:"fire-perf",[Fg]:"fire-perf-compat",[Vg]:"fire-rc",[jg]:"fire-rc-compat",[Bg]:"fire-gcs",[qg]:"fire-gcs-compat",[Hg]:"fire-fst",[zg]:"fire-fst-compat","fire-js":"fire-js",[Wg]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Jg={["no-app"]:"No Firebase App '{$appName}' has been created - call initializeApp() first",["bad-app-name"]:"Illegal App name: '{$appName}",["duplicate-app"]:"Firebase App named '{$appName}' already exists with different options or config",["app-deleted"]:"Firebase App named '{$appName}' already deleted",["no-options"]:"Need to provide options, when not being deployed to hosting via source.",["invalid-app-argument"]:"firebase.{$appName}() takes either no argument or a Firebase App instance.",["invalid-log-argument"]:"First argument to `onLog` must be null or a function.",["idb-open"]:"Error thrown when opening IndexedDB. Original error: {$originalErrorMessage}.",["idb-get"]:"Error thrown when reading from IndexedDB. Original error: {$originalErrorMessage}.",["idb-set"]:"Error thrown when writing to IndexedDB. Original error: {$originalErrorMessage}.",["idb-delete"]:"Error thrown when deleting from IndexedDB. Original error: {$originalErrorMessage}."},Zt=new Kr("app","Firebase",Jg);/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const rr=Kg;function Du(t,e={}){let n=t;typeof e!="object"&&(e={name:e});const r=Object.assign({name:fo,automaticDataCollectionEnabled:!1},e),s=r.name;if(typeof s!="string"||!s)throw Zt.create("bad-app-name",{appName:String(s)});if(n||(n=Ru()),!n)throw Zt.create("no-options");const i=Fs.get(s);if(i){if(Us(n,i.options)&&Us(r,i.config))return i;throw Zt.create("duplicate-app",{appName:s})}const o=new ig(s);for(const c of po.values())o.addComponent(c);const a=new Qg(n,r,o);return Fs.set(s,a),a}function xu(t=fo){const e=Fs.get(t);if(!e&&t===fo&&Ru())return Du();if(!e)throw Zt.create("no-app",{appName:t});return e}function en(t,e,n){var r;let s=(r=Gg[t])!==null&&r!==void 0?r:t;n&&(s+=`-${n}`);const i=s.match(/\s|\//),o=e.match(/\s|\//);if(i||o){const a=[`Unable to register library "${s}" with version "${e}":`];i&&a.push(`library name "${s}" contains illegal characters (whitespace or "/")`),i&&o&&a.push("and"),o&&a.push(`version name "${e}" contains illegal characters (whitespace or "/")`),En.warn(a.join(" "));return}Jn(new bn(`${s}-version`,()=>({library:s,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Xg="firebase-heartbeat-database",Zg=1,Lr="firebase-heartbeat-store";let ji=null;function Nu(){return ji||(ji=_g(Xg,Zg,{upgrade:(t,e)=>{switch(e){case 0:t.createObjectStore(Lr)}}}).catch(t=>{throw Zt.create("idb-open",{originalErrorMessage:t.message})})),ji}async function ey(t){try{return await(await Nu()).transaction(Lr).objectStore(Lr).get(Lu(t))}catch(e){if(e instanceof Ut)En.warn(e.message);else{const n=Zt.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});En.warn(n.message)}}}async function Cl(t,e){try{const r=(await Nu()).transaction(Lr,"readwrite");await r.objectStore(Lr).put(e,Lu(t)),await r.done}catch(n){if(n instanceof Ut)En.warn(n.message);else{const r=Zt.create("idb-set",{originalErrorMessage:n==null?void 0:n.message});En.warn(r.message)}}}function Lu(t){return`${t.name}!${t.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function oy(t){Jn(new bn("platform-logger",e=>new bg(e),"PRIVATE")),Jn(new bn("heartbeat",e=>new ry(e),"PRIVATE")),en(ho,Sl,t),en(ho,Sl,"esm2017"),en("fire-js","")}oy("");var ay="firebase",ly="9.22.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Yu(t){var e,n;return((n=(((e=t==null?void 0:t.mapValue)===null||e===void 0?void 0:e.fields)||{}).__type__)===null||n===void 0?void 0:n.stringValue)==="server_timestamp"}function Ju(t){const e=t.mapValue.fields.__previous_value__;return Yu(e)?Ju(e):e}function Fr(t){const e=An(t.mapValue.fields.__local_write_time__.timestampValue);return new it(e.seconds,e.nanos)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Qe{constructor(e,n,r){this.converter=n,this._key=r,this.type="document",this.firestore=e}get _path(){return this._key.path}get id(){return this._key.path.lastSegment()}get path(){return this._key.path.canonicalString()}get parent(){return new tn(this.firestore,this.converter,this._key.path.popLast())}withConverter(e){return new Qe(this.firestore,e,this._key)}}class sn{constructor(e,n,r){this.converter=n,this._query=r,this.type="query",this.firestore=e}withConverter(e){return new sn(this.firestore,e,this._query)}}class tn extends sn{constructor(e,n,r){super(e,n,new mi(r)),this._path=r,this.type="collection"}get id(){return this._query.path.lastSegment()}get path(){return this._query.path.canonicalString()}get parent(){const e=this._path.popLast();return e.isEmpty()?null:new Qe(this.firestore,null,new Fe(e))}withConverter(e){return new tn(this.firestore,e,this._path)}}function _e(t,e,...n){if(t=je(t),zu("collection","path",e),t instanceof Zr){const r=Le.fromString(e,...n);return Dl(r),new tn(t,null,r)}{if(!(t instanceof Qe||t instanceof tn))throw new Y(Z,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const r=t._path.child(Le.fromString(e,...n));return Dl(r),new tn(t.firestore,null,r)}}function Se(t,e,...n){if(t=je(t),arguments.length===1&&(e=Ay.N()),zu("doc","path",e),t instanceof Zr){const r=Le.fromString(e,...n);return kl(r),new Qe(t,null,new Fe(r))}{if(!(t instanceof Qe||t instanceof tn))throw new Y(Z,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const r=t._path.child(Le.fromString(e,...n));return kl(r),new Qe(t.firestore,t instanceof tn?t.converter:null,new Fe(r))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function _d(t,e,n){let r;return r=t?n&&(n.merge||n.mergeFields)?t.toFirestore(e,n):t.toFirestore(e):e,r}class fa extends class{convertValue(e,n="none"){switch(Sn(e)){case 0:return null;case 1:return e.booleanValue;case 2:return Ne(e.integerValue||e.doubleValue);case 3:return this.convertTimestamp(e.timestampValue);case 4:return this.convertServerTimestamp(e,n);case 5:return e.stringValue;case 6:return this.convertBytes(Ur(e.bytesValue));case 7:return this.convertReference(e.referenceValue);case 8:return this.convertGeoPoint(e.geoPointValue);case 9:return this.convertArray(e.arrayValue,n);case 10:return this.convertObject(e.mapValue,n);default:throw be()}}convertObject(e,n){return this.convertObjectMap(e.fields,n)}convertObjectMap(e,n="none"){const r={};return Qr(e,(s,i)=>{r[s]=this.convertValue(i,n)}),r}convertGeoPoint(e){return new na(Ne(e.latitude),Ne(e.longitude))}convertArray(e,n){return(e.values||[]).map(r=>this.convertValue(r,n))}convertServerTimestamp(e,n){switch(n){case"previous":const r=Ju(e);return r==null?null:this.convertValue(r,n);case"estimate":return this.convertTimestamp(Fr(e));default:return null}}convertTimestamp(e){const n=An(e);return new it(n.seconds,n.nanos)}convertDocumentKey(e,n){const r=Le.fromString(e);st(id(r));const s=new $r(r.get(1),r.get(3)),i=new Fe(r.popFirst(5));return s.isEqual(n)||fi(`Document ${i} contains a document reference within a different database (${s.projectId}/${s.database}) which is not supported. It will be treated as a reference in the current database (${n.projectId}/${n.database}) instead.`),i}}{constructor(e){super(),this.firestore=e}convertBytes(e){return new Xn(e)}convertReference(e){const n=this.convertDocumentKey(e,this.firestore._databaseId);return new Qe(this.firestore,null,n)}}function mt(t){const e=vi((t=Jr(t,Qe)).firestore),n=new fa(t.firestore);return ld(e,[t._key]).then(r=>{st(r.length===1);const s=r[0];return new Gs(t.firestore,n,t._key,s.isFoundDocument()?s:null,t.converter)})}function Ct(t){(function(r){if(r.limitType==="L"&&r.explicitOrderBy.length===0)throw new Y(Yo,"limitToLast() queries require specifying at least one orderBy() clause")})((t=Jr(t,sn))._query);const e=vi(t.firestore),n=new fa(t.firestore);return r_(e,t._query).then(r=>{const s=r.map(i=>new md(t.firestore,n,i.key,i,t.converter));return t._query.limitType==="L"&&s.reverse(),new f_(t,s)})}function Ft(t,e,n){const r=_d((t=Jr(t,Qe)).converter,e,n),s=dd(sa(t.firestore),"setDoc",t._key,r,t.converter!==null,n);return ad(vi(t.firestore),[s.toMutation(t._key,It.none())])}function gs(t,e){if((t=je(t)).firestore!==e)throw new Y(Z,"Provided document reference is from a different Firestore instance.");return t}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ys=new qo("@firebase/auth");function b_(t,...e){Ys.logLevel<=me.WARN&&Ys.warn(`Auth (${rr}): ${t}`,...e)}function Ss(t,...e){Ys.logLevel<=me.ERROR&&Ys.error(`Auth (${rr}): ${t}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function T_(){return typeof navigator<"u"&&navigator&&"onLine"in navigator&&typeof navigator.onLine=="boolean"&&(I_()||Hm()||"connection"in navigator)?navigator.onLine:!0}function A_(){if(typeof navigator>"u")return null;const t=navigator;return t.languages&&t.languages[0]||t.language||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ar(t){if(t)try{const e=new Date(Number(t));if(!isNaN(e.getTime()))return e.toUTCString()}catch{}}async function k_(t,e=!1){const n=je(t),r=await n.getIdToken(e),s=_a(r);re(s&&s.exp&&s.auth_time&&s.iat,n.auth,"internal-error");const i=typeof s.firebase=="object"?s.firebase:void 0,o=i==null?void 0:i.sign_in_provider;return{claims:s,token:r,authTime:Ar(zi(s.auth_time)),issuedAtTime:Ar(zi(s.iat)),expirationTime:Ar(zi(s.exp)),signInProvider:o||null,signInSecondFactor:(i==null?void 0:i.sign_in_second_factor)||null}}function zi(t){return Number(t)*1e3}function _a(t){const[e,n,r]=t.split(".");if(e===void 0||n===void 0||r===void 0)return Ss("JWT malformed, contained fewer than 3 sections"),null;try{const s=Su(n);return s?JSON.parse(s):(Ss("Failed to decode base64 JWT payload"),null)}catch(s){return Ss("Caught error parsing JWT payload as JSON",s==null?void 0:s.toString()),null}}function D_(t){const e=_a(t);return re(e,"internal-error"),re(typeof e.exp<"u","internal-error"),re(typeof e.iat<"u","internal-error"),Number(e.exp)-Number(e.iat)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ad{constructor(){this.type="NONE",this.storage={}}async _isAvailable(){return!0}async _set(e,n){this.storage[e]=n}async _get(e){const n=this.storage[e];return n===void 0?null:n}async _remove(e){delete this.storage[e]}_addListener(e,n){}_removeListener(e,n){}}Ad.type="NONE";const Xl=Ad;/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Zl(t){const e=t.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(Rd(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(Sd(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(Pd(e))return"Blackberry";if(kd(e))return"Webos";if(va(e))return"Safari";if((e.includes("chrome/")||Cd(e))&&!e.includes("edge/"))return"Chrome";if(Od(e))return"Android";{const n=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,r=t.match(n);if((r==null?void 0:r.length)===2)return r[1]}return"Other"}function Sd(t=ze()){return/firefox\//i.test(t)}function va(t=ze()){const e=t.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function Cd(t=ze()){return/crios\//i.test(t)}function Rd(t=ze()){return/iemobile/i.test(t)}function Od(t=ze()){return/android/i.test(t)}function Pd(t=ze()){return/blackberry/i.test(t)}function kd(t=ze()){return/webos/i.test(t)}function Ai(t=ze()){return/iphone|ipad|ipod/i.test(t)||/macintosh/i.test(t)&&/mobile/i.test(t)}function F_(t=ze()){var e;return Ai(t)&&!!(!((e=window.navigator)===null||e===void 0)&&e.standalone)}function V_(){return Wm()&&document.documentMode===10}function Dd(t=ze()){return Ai(t)||Od(t)||kd(t)||Pd(t)||/windows phone/i.test(t)||Rd(t)}function j_(){try{return!!(window&&window!==window.top)}catch{return!1}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Wt extends ss{constructor(){super("facebook.com")}static credential(e){return Rn._fromParams({providerId:Wt.PROVIDER_ID,signInMethod:Wt.FACEBOOK_SIGN_IN_METHOD,accessToken:e})}static credentialFromResult(e){return Wt.credentialFromTaggedObject(e)}static credentialFromError(e){return Wt.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e||!("oauthAccessToken"in e)||!e.oauthAccessToken)return null;try{return Wt.credential(e.oauthAccessToken)}catch{return null}}}Wt.FACEBOOK_SIGN_IN_METHOD="facebook.com";Wt.PROVIDER_ID="facebook.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Gt extends ss{constructor(){super("github.com")}static credential(e){return Rn._fromParams({providerId:Gt.PROVIDER_ID,signInMethod:Gt.GITHUB_SIGN_IN_METHOD,accessToken:e})}static credentialFromResult(e){return Gt.credentialFromTaggedObject(e)}static credentialFromError(e){return Gt.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e||!("oauthAccessToken"in e)||!e.oauthAccessToken)return null;try{return Gt.credential(e.oauthAccessToken)}catch{return null}}}Gt.GITHUB_SIGN_IN_METHOD="github.com";Gt.PROVIDER_ID="github.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class _v{constructor(e){this.target=e,this.handlers=new Set}removeMessageHandler(e){e.messageChannel&&(e.messageChannel.port1.removeEventListener("message",e.onMessage),e.messageChannel.port1.close()),this.handlers.delete(e)}async _send(e,n,r=50){const s=typeof MessageChannel<"u"?new MessageChannel:null;if(!s)throw new Error("connection_unavailable");let i,o;return new Promise((a,c)=>{const h=Ea("",20);s.port1.start();const m=setTimeout(()=>{c(new Error("unsupported_event"))},r);o={messageChannel:s,onMessage(b){const S=b;if(S.data.eventId===h)switch(S.data.status){case"ack":clearTimeout(m),i=setTimeout(()=>{c(new Error("timeout"))},3e3);break;case"done":clearTimeout(i),a(S.data.response);break;default:clearTimeout(m),clearTimeout(i),c(new Error("invalid_response"));break}}},this.handlers.add(o),s.port1.addEventListener("message",o.onMessage),this.target.postMessage({eventType:e,eventId:h,data:n},[s.port2])}).finally(()=>{o&&this.removeMessageHandler(o)})}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function At(){return window}function vv(t){At().location.href=t}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Wd(){return typeof At().WorkerGlobalScope<"u"&&typeof At().importScripts=="function"}async function wv(){if(!(navigator!=null&&navigator.serviceWorker))return null;try{return(await navigator.serviceWorker.ready).active}catch{return null}}function bv(){var t;return((t=navigator==null?void 0:navigator.serviceWorker)===null||t===void 0?void 0:t.controller)||null}function Ev(){return Wd()?self:null}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Yv=new ns(3e4,6e4);function ac(){const t=At().___jsl;if(t!=null&&t.H){for(const e of Object.keys(t.H))if(t.H[e].r=t.H[e].r||[],t.H[e].L=t.H[e].L||[],t.H[e].r=[...t.H[e].L],t.CP)for(let n=0;n<t.CP.length;n++)t.CP[n]=null}}function Jv(t){return new Promise((e,n)=>{var r,s,i;function o(){ac(),gapi.load("gapi.iframes",{callback:()=>{e(gapi.iframes.getContext())},ontimeout:()=>{ac(),n(Tt(t,"network-request-failed"))},timeout:Yv.get()})}if(!((s=(r=At().gapi)===null||r===void 0?void 0:r.iframes)===null||s===void 0)&&s.Iframe)e(gapi.iframes.getContext());else if(!((i=At().gapi)===null||i===void 0)&&i.load)o();else{const a=q_("iframefcb");return At()[a]=()=>{gapi.load?o():n(Tt(t,"network-request-failed"))},$d(`https://apis.google.com/js/api.js?onload=${a}`).catch(c=>n(c))}}).catch(e=>{throw Os=null,e})}let Os=null;function Qv(t){return Os=Os||Jv(t),Os}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const bw=5*60,Ew=Ou("authIdTokenMaxAge")||bw;let hc=null;const Iw=t=>async e=>{const n=e&&await e.getIdTokenResult(),r=n&&(new Date().getTime()-Date.parse(n.issuedAtTime))/1e3;if(r&&r>Ew)return;const s=n==null?void 0:n.token;hc!==s&&(hc=s,await fetch(t,{method:s?"POST":"DELETE",headers:s?{Authorization:`Bearer ${s}`}:{}}))};function vs(t=xu()){const e=zo(t,"auth");if(e.isInitialized())return e.getImmediate();const n=Y_(t,{popupRedirectResolver:yw,persistence:[Rv,gv,zd]}),r=Ou("authTokenSyncURL");if(r){const i=Iw(r);hv(n,i,()=>i(n.currentUser)),dv(n,o=>i(o))}const s=Cu("auth");return s&&Q_(n,`http://${s}`),n}ww("Browser");const Tw={apiKey:"AIzaSyAET8eUrZHm1IrHhzl2FaWfW1Jr4Wqo7IA",authDomain:"gold-smith-aljihad.firebaseapp.com",projectId:"gold-smith-aljihad",storageBucket:"gold-smith-aljihad.appspot.com",messagingSenderId:"265121429939",appId:"1:265121429939:web:419003c9403699fd8273c6",measurementId:"G-4B9DDZDD8V"},Aw=Du(Tw),ge=s_(Aw);class Sw{constructor(){this.collectionName=De.INVOICES}async addOrUpdate(e){const n=_e(ge,this.collectionName);var r=await mt(Se(n,e.invoiceNumber));if(r.exists())throw"Invoice cannot be updated";an.fillUpdatedInfo(e),await Ft(Se(n,e.invoiceNumber),e),await Uw.addOrUpdate({receiptNumber:"PR"+e.invoiceNumber,invoiceRef:e.invoiceNumber,paymentDate:e.purchaseDate,amount:-1*e.totals.totalMakingCharge,customer:e.customer,customerId:e.customerId,description:"Auto added by purchase"+e.invoiceNumber}),await Fw.addOrUpdate({receiptNumber:"GR"+e.invoiceNumber,invoiceRef:e.invoiceNumber,paymentDate:e.purchaseDate,weight:-1*e.totals.pureWeight,purity:1e3,customer:e.customer,customerId:e.customerId,description:"Auto added by purchase"+e.invoiceNumber}),on.log(e,"Invoice","Created"+e.invoiceNumber)}async list(e,n,r){const s=_e(ge,this.collectionName),i=Lt(s,ts("purchaseDate","desc"),Ti(10)),a=(await Ct(i)).docs.map(h=>h.data());if(r){var c=r.toLowerCase().trim();return _.filter(a,function(h){return h.invoiceNumber.toLowerCase().includes(c)||h.customer.toLowerCase().includes(c)})}return a}async listByCustomer(e){if(!e)return[];const n=_e(ge,this.collectionName),r=Lt(n,Ii("customerId","==",e));return(await Ct(r)).docs.map(o=>o.data())}async getById(e){const n=_e(ge,this.collectionName);var r=await mt(Se(n,e));if(r.exists())return r.data()}}class Cw{constructor(){this.collectionName=De.SETTINGS}async addOrUpdate(e){const n=_e(ge,this.collectionName);an.fillUpdatedInfo(e),await Ft(Se(n,e.identifier),e),on.log(e,"Settings","Changed settings "+e.identifier)}async getById(e){const n=_e(ge,this.collectionName),r=await mt(Se(n,e));return r.exists()?r.data():{identifier:e}}}class Rw{constructor(){this.collectionName=De.USERS}async addOrUpdate(e){const n=_e(ge,this.collectionName);var r="Updated";e.id||(e.id=e.Email,r="Added");const s=e.Password;e.Password=null,an.fillUpdatedInfo(e),await Ft(Se(n,e.Email),e),on.log(e,"User",r+":"+JSON.stringify(e)),r=="Added"&&await os.createUser(e.Email,s)}async getById(e){if(!e)return;const n=_e(ge,this.collectionName);var r=await mt(Se(n,e));if(r.exists())return r.data()}async list(){const e=_e(ge,this.collectionName);return(await Ct(e)).docs.map(s=>s.data())}}class Ow{constructor(){this.collectionName=De.USER_CUSTOMER_MAPPING}async list(e){const n=_e(ge,this.collectionName);var r=await mt(Se(n,e));return r.exists()?r.data().customers:[]}async addOrUpdate(e,n){const r=_e(ge,this.collectionName);return await Ft(Se(r,e),{customers:n})}}class Pw{constructor(){this.collectionName=De.RATES}async addOrUpdate(e){let n=Yn.getTodayAsString();const r=_e(ge,this.collectionName);var s={rate:e.rate,date:n};an.fillUpdatedInfo(s),await Ft(Se(r,n),s),on.log(s,"Rate","Changed rate to "+s.rate)}async list(){const e=_e(ge,this.collectionName),n=Lt(e,ts("date","desc"),Ti(10));return(await Ct(n)).docs.map(i=>i.data())}async getTodaysRate(){let e=Yn.getTodayAsString();const n=_e(ge,this.collectionName);var r=await mt(Se(n,e));if(r.exists())return r.data().rate}}class kw{constructor(){this.collectionName=De.CCUSTOMERS}async list(e,n=!1,r=!1){const s=_e(ge,this.collectionName);var i=null;n&&(i=Ii("status","==","Active"));const o=Lt(s,i);var c=(await Ct(o)).docs.map(h=>h.data());if(!r){console.log("Called");const h=await Vw.list(os.getCurrentUser().email);c=_.filter(c,function(m){return h.includes(m.id)})}if(e){const h=e.toLowerCase();c=_.filter(c,function(m){return m.Name.toLowerCase().includes(h)||m.Contact&&m.Contact.toString().toLowerCase().includes(h)})}return c=_.sortBy(c,function(h){return h.Name}),c}async addOrUpdate(e){const n=_e(ge,this.collectionName);var r="Updated";e.id||(e.id=Se(n).id,r="Added"),an.fillUpdatedInfo(e),await Ft(Se(n,e.id),e),on.log(e,"Customer",r+":"+JSON.stringify(e))}async getById(e){const n=_e(ge,this.collectionName);var r=await mt(Se(n,e));if(r.exists())return r.data()}async runDebitCreditTransaction(e,n,r){const s=Se(_e(ge,this.collectionName),e);try{await v_(ge,async i=>{const o=await i.get(s);if(!o.exists())throw"Document does not exist!";const a=r+"Debit",c=r+"Credit",h=o.data();n<0?h[a]?h[a]+=n*-1:h[a]=n*-1:h[c]?h[c]+=n:h[c]=n,i.update(s,h)}),console.log("Transaction successfully committed!")}catch(i){console.log("Transaction failed: ",i)}}}class Dw{constructor(){this.collectionName=De.PRODUCTS}async list(e){const n=_e(ge,this.collectionName),r=Lt(n,ts("Name"));var i=(await Ct(r)).docs.map(o=>o.data());if(e){const o=e.toLowerCase();i=_.filter(i,function(a){return a.Name.toLowerCase().includes(o)})}return i}async addOrUpdate(e){const n=_e(ge,this.collectionName);var r="Updated";e.id||(e.id=Se(n).id,r="Added"),an.fillUpdatedInfo(e),await Ft(Se(n,e.id),e),on.log(e,"Product",r+":"+JSON.stringify(e))}}class xw{constructor(){this.collectionName=De.CASH_PAYMENTS}async addOrUpdate(e){const n=_e(ge,this.collectionName);var r=await mt(Se(n,e.receiptNumber));if(r.exists())throw"Cash payment cannot be updated";an.fillUpdatedInfo(e),await Ft(Se(n,e.receiptNumber),e),await Xd.runDebitCreditTransaction(e.customerId,e.amount,"Cash"),on.log(e,"CashPayment","Added :"+e.receiptNumber)}async list(e,n){const r=_e(ge,this.collectionName),s=Lt(r,ts("paymentDate","desc"),Ti(10));return(await Ct(s)).docs.map(a=>a.data())}async listByCustomer(e){if(!e)return[];const n=_e(ge,this.collectionName),r=Lt(n,Ii("customerId","==",e));return(await Ct(r)).docs.map(o=>o.data())}async getById(e){const n=_e(ge,this.collectionName);var r=await mt(Se(n,e));if(r.exists())return r.data()}}class Nw{constructor(){this.collectionName=De.GOLD_PAYMENTS}async addOrUpdate(e){const n=_e(ge,this.collectionName);var r=await mt(Se(n,e.receiptNumber));if(r.exists())throw"Gold Payment cannot be updated";an.fillUpdatedInfo(e),await Ft(Se(n,e.receiptNumber),e),await Xd.runDebitCreditTransaction(e.customerId,e.weight*(e.purity/1e3),"Gold"),on.log(e,"GoldPayment","Added :"+e.receiptNumber)}async list(e,n){const r=_e(ge,this.collectionName),s=Lt(r,ts("paymentDate","desc"),Ti(10));return(await Ct(s)).docs.map(a=>a.data())}async listByCustomer(e){if(!e)return[];const n=_e(ge,this.collectionName),r=Lt(n,Ii("customerId","==",e));return(await Ct(r)).docs.map(o=>o.data())}async getById(e){const n=_e(ge,this.collectionName);var r=await mt(Se(n,e));if(r.exists())return r.data()}}class Lw{async tryLogin(e,n){const r=vs();return await uv(r,e,n)}getCurrentUser(){return vs().currentUser}async createUser(e,n){return await cv(vs(),e,n)}async signOut(){this.getCurrentUser()&&await vs().signOut()}}class $w{constructor(){this.collectionName=De.AUDIT}async log(e,n,r){_e(ge,this.collectionName)}}class Mw{fillUpdatedInfo(e){const n=os.getCurrentUser();e.updatedByDisplayName=n.displayName??n.email,e.updatedBy=n.uid,e.updatedOn=Yn.getNowAsMilliSeconds()}}const Ob=new Sw,Pb=new Rw,kb=new Pw,Xd=new kw,Db=new Dw,xb=new Cw,Uw=new xw,Fw=new Nw,os=new Lw,on=new $w,an=new Mw,Vw=new Ow,jw=(t,e)=>{const n=t.__vccOpts||t;for(const[r,s]of e)n[r]=s;return n},Bw={data:function(){return{hasAdminPrivillage:!1}},mounted:function(){this.hasAdminPrivillage=os.getCurrentUser().email==this.$adminMailId}},qw={class:"navbar navbar-expand-lg navbar-light bg-light"},Hw={class:"container-fluid"},zw=de("button",{class:"navbar-toggler",type:"button","data-bs-toggle":"collapse","data-bs-target":"#navbarTogglerDemo02","aria-controls":"navbarTogglerDemo02","aria-expanded":"false","aria-label":"Toggle navigation"},[de("span",{class:"navbar-toggler-icon"})],-1),Ww={class:"collapse navbar-collapse",id:"navbarTogglerDemo02"},Kw={class:"navbar-nav me-auto mb-2 mb-lg-0"},Gw={class:"nav-item"},Yw={class:"nav-item"},Jw={class:"nav-item"},Qw={class:"nav-item"},Xw={class:"nav-item"},Zw={key:0,class:"nav-item"},eb={class:"nav-item"},tb={class:"nav-item"},nb={class:"navbar-nav me-auto mb-2 mb-lg-0"},rb={class:"nav-item dropdown"},sb=de("a",{class:"nav-link dropdown-toggle",href:"#",id:"navbarDropdown",role:"button","data-bs-toggle":"dropdown","aria-expanded":"false"},"Settings ",-1),ib={class:"dropdown-menu","aria-labelledby":"navbarDropdown"},ob={key:0},ab=de("li",null,[de("hr",{class:"dropdown-divider"})],-1),lb={class:"d-flex"},cb={class:"navbar-nav me-auto mb-2 mb-lg-0"},ub={class:"nav-item dropdown btn btn-outline-success"},db=de("a",{class:"nav-link dropdown-toggle",href:"#",id:"navbarDropdown",role:"button","data-bs-toggle":"dropdown","aria-expanded":"false"}," New ",-1),hb={class:"dropdown-menu","aria-labelledby":"navbarDropdown"};function fb(t,e,n,r,s,i){const o=Tf("RouterLink");return _n(),ki(ot,null,[de("nav",qw,[de("div",Hw,[we(o,{class:"navbar-brand",to:"/"},{default:Ke(()=>[de("h3",null,pc(this.$appShortName),1)]),_:1}),zw,de("div",Ww,[de("ul",Kw,[de("li",Gw,[we(o,{to:"/invoices",class:"nav-link active","aria-current":"page"},{default:Ke(()=>[tt("Invoices")]),_:1})]),de("li",Yw,[we(o,{to:"/customers",class:"nav-link active","aria-current":"page"},{default:Ke(()=>[tt("Customers")]),_:1})]),de("li",Jw,[we(o,{to:"/products",class:"nav-link active","aria-current":"page"},{default:Ke(()=>[tt("Products")]),_:1})]),de("li",Qw,[we(o,{to:"/payments",class:"nav-link active","aria-current":"page"},{default:Ke(()=>[tt("Cash Transactions")]),_:1})]),de("li",Xw,[we(o,{to:"/goldtransactions",class:"nav-link active","aria-current":"page"},{default:Ke(()=>[tt("Gold Transactions")]),_:1})]),t.hasAdminPrivillage?(_n(),ki("li",Zw,[we(o,{to:"/users",class:"nav-link active","aria-current":"page"},{default:Ke(()=>[tt("Users")]),_:1})])):Wa("",!0),de("li",eb,[we(o,{to:"/rates",class:"nav-link active","aria-current":"page"},{default:Ke(()=>[tt("Metal Rate")]),_:1})]),de("li",tb,[de("ul",nb,[de("li",rb,[sb,de("ul",ib,[t.hasAdminPrivillage?(_n(),ki("li",ob,[we(o,{to:"/settings/application",class:"dropdown-item","aria-current":"page"},{default:Ke(()=>[tt(" General Settings")]),_:1})])):Wa("",!0),ab,de("li",null,[we(o,{to:"/logout",class:"nav-link active","aria-current":"page"},{default:Ke(()=>[tt("Logout ")]),_:1})])])])])])]),de("form",lb,[de("ul",cb,[de("li",ub,[db,de("ul",hb,[de("li",null,[we(o,{to:"/invoice",class:"dropdown-item"},{default:Ke(()=>[tt(" Invoice")]),_:1})]),de("li",null,[we(o,{to:"/payment",class:"dropdown-item"},{default:Ke(()=>[tt(" Cash Payment")]),_:1})]),de("li",null,[we(o,{to:"/goldtransaction",class:"dropdown-item"},{default:Ke(()=>[tt(" Gold Payment")]),_:1})])])])])])])])]),Cf(t.$slots,"default")],64)}const pb=jw(Bw,[["render",fb]]),mb={class:"pricing-header p-3 pb-md-4 mx-auto text-center"},gb={class:"display-4 fw-normal"},yb=de("p",{class:"fs-5 text-body-secondary"},null,-1),_b={mounted:function(){}},vb=Object.assign(_b,{__name:"HomeView",setup(t){return(e,n)=>(_n(),ci(pb,null,{default:Ke(()=>[de("div",mb,[de("h2",gb,"Welcome to "+pc(e.$appname),1),yb])]),_:1}))}}),Zd=Rm({history:zp("/aljihad/"),routes:[{path:"/",name:"home",component:vb},{path:"/invoice",name:"invoice",component:()=>Me(()=>import("./Invoice-4e969315.js"),["assets/Invoice-4e969315.js","assets/InvoiceItemTable-91bcc51d.js","assets/CAlert-512d725c.js","assets/CustomerPicker-8ebfa374.js"])},{path:"/invoices/:invoicenumber",name:"invoicereport",component:()=>Me(()=>import("./InvoiceReport-31258769.js"),["assets/InvoiceReport-31258769.js","assets/InvoiceItemTable-91bcc51d.js","assets/CAlert-512d725c.js"])},{path:"/login",name:"login",component:()=>Me(()=>import("./Login-5626f5c5.js"),["assets/Login-5626f5c5.js","assets/CAlert-512d725c.js"])},{path:"/logout",name:"logout",component:()=>Me(()=>import("./Logout-cdeff510.js"),["assets/Logout-cdeff510.js","assets/CAlert-512d725c.js"])},{path:"/customers",name:"customers",component:()=>Me(()=>import("./Customers-c74c912c.js"),["assets/Customers-c74c912c.js","assets/DynamicTable-70d65d2a.js","assets/DynamicDialog-395e06f4.js","assets/CAlert-512d725c.js"])},{path:"/customers/:customerid",name:"customerdetails",component:()=>Me(()=>import("./CustomerDetails-f49cad01.js"),["assets/CustomerDetails-f49cad01.js","assets/CAlert-512d725c.js","assets/TwoColumnTable-2f308f1c.js","assets/DynamicTable-70d65d2a.js"])},{path:"/users",name:"users",component:()=>Me(()=>import("./Users-5895e558.js"),["assets/Users-5895e558.js","assets/DynamicTable-70d65d2a.js","assets/DynamicDialog-395e06f4.js","assets/CAlert-512d725c.js"])},{path:"/invoices",name:"invoices",component:()=>Me(()=>import("./Invoices-3cc3b1f1.js"),["assets/Invoices-3cc3b1f1.js","assets/CAlert-512d725c.js","assets/DynamicTable-70d65d2a.js"])},{path:"/rates",name:"rates",component:()=>Me(()=>import("./Rates-369b9dfb.js"),["assets/Rates-369b9dfb.js","assets/DynamicTable-70d65d2a.js","assets/CAlert-512d725c.js"])},{path:"/products",name:"products",component:()=>Me(()=>import("./Products-a7094461.js"),["assets/Products-a7094461.js","assets/DynamicTable-70d65d2a.js","assets/DynamicDialog-395e06f4.js","assets/CAlert-512d725c.js"])},{path:"/settings/application",name:"applicationsettings",component:()=>Me(()=>import("./Applicationsettings-281d68c0.js"),["assets/Applicationsettings-281d68c0.js","assets/CAlert-512d725c.js","assets/TwoColumnTable-2f308f1c.js"])},{path:"/settings/product",name:"productSettings",component:()=>Me(()=>import("./ProductSettings-bb633102.js"),["assets/ProductSettings-bb633102.js","assets/DynamicTable-70d65d2a.js","assets/DynamicDialog-395e06f4.js","assets/CAlert-512d725c.js"])},{path:"/settings/customer",name:"customerSettings",component:()=>Me(()=>import("./CustomerSettings-6c23a291.js"),["assets/CustomerSettings-6c23a291.js","assets/DynamicTable-70d65d2a.js","assets/DynamicDialog-395e06f4.js","assets/CAlert-512d725c.js"])},{path:"/payments",name:"payments",component:()=>Me(()=>import("./Payments-3e163f4d.js"),["assets/Payments-3e163f4d.js","assets/DynamicTable-70d65d2a.js","assets/CAlert-512d725c.js"])},{path:"/payment",name:"payment",component:()=>Me(()=>import("./Payment-6141fb8e.js"),["assets/Payment-6141fb8e.js","assets/CustomerPicker-8ebfa374.js","assets/CAlert-512d725c.js"])},{path:"/payments/:receiptNumber",name:"paymentReport",component:()=>Me(()=>import("./PaymentReport-c0c30d61.js"),["assets/PaymentReport-c0c30d61.js","assets/CAlert-512d725c.js"])},{path:"/goldtransactions",name:"goldtransactions",component:()=>Me(()=>import("./GoldTransactions-8cbd2f6b.js"),["assets/GoldTransactions-8cbd2f6b.js","assets/DynamicTable-70d65d2a.js","assets/CAlert-512d725c.js"])},{path:"/goldtransaction",name:"goldtransaction",component:()=>Me(()=>import("./GoldTransaction-ee889666.js"),["assets/GoldTransaction-ee889666.js","assets/CustomerPicker-8ebfa374.js","assets/CAlert-512d725c.js"])}]}),ln=Sp(Pm);ln.use(Zd);ln.mount("#app");ln.config.globalProperties.$appname="AL JIHAD JEWELLERY MAKERS";ln.config.globalProperties.$appShortName="AL JIHAD";ln.config.globalProperties.$basedomainname="/aljihad/";ln.config.globalProperties.$adminMailId="admin@aljihad.com";ln.config.globalProperties.$statusLabelMapper={enabled:"Active",disabled:"Inactive"};ln.config.globalProperties.$alertShowDuration=3e3;Zd.beforeEach((t,e,n)=>{if(t.path.startsWith("/payments/")||t.path.startsWith("/invoices/")||t.path.startsWith("/login")||t.path.startsWith("/goldtransaction/")){n();return}os.getCurrentUser()?n():n({path:"/login",query:{nextUrl:t.path}})});export{Yl as A,Io as B,Yn as C,ys as D,Vw as E,ot as F,Ab as G,Pb as H,Rb as I,Ib as J,Hi as S,jw as _,Wa as a,de as b,ki as c,Tf as d,Cb as e,we as f,Tb as g,ci as h,Ke as i,pb as j,kb as k,Ob as l,tt as m,Xd as n,_n as o,Db as p,Cf as q,Eb as r,xb as s,pc as t,yn as u,Sb as v,bb as w,os as x,Uw as y,Fw as z};
